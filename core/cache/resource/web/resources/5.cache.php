<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Водопад и потерянные вещи',
    'longtitle' => 'Потерянные в Ниагарском парке вещи продадут с аукциона',
    'description' => '',
    'alias' => 'vodopad-i-poteryannyie-veshhi',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p>Солнечные очки, штативы, прогулочные детские коляски и другие вещи, потерянные в Ниагарском парке, будут проданы с аукциона. Как сообщает The Daily Mail, это произойдет, если за ними не обратятся первоначальные владельцы.</p>
<p>
Чтобы вернуть ювелирные украшения, мобильные телефоны, кошельки, сумки и другие вещи, на официальном сайте парка можно оставить сообщение о том, какая вещь, где и когда была утеряна. Если к концу года владелец вещи не объявится, она станет лотом канадского аукциона Luke\'s Auctions.
</p>
<p>Девиз аукциона — «по крайней мере, вы вернетесь домой с чем-нибудь». Ставки будут начинаться от пяти долларов за предмет, первоначальная стоимость которого составляла 100 долларов.</p>
<p>Отмечается, что стражи порядка, работающие в парке, ежегодно получают более 600 потерянных или оставленных вещей. В настоящее время более 170-ти предметов остаются без владельцев. Руководство парка намерено потратить вырученные от аукциона деньги на благоустройство территории. В частотности, планируется высадить пять тысяч деревьев на территории.</p>',
    'richtext' => 1,
    'template' => 4,
    'menuindex' => 1,
    'searchable' => 1,
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1460635965,
    'editedby' => 1,
    'editedon' => 1460659436,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1460635920,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'stati/vodopad-i-poteryannyie-veshhi',
    'uri_override' => 0,
    ...
    array (
      0 => 'image',
      1 => 'assets/basetheme-design/images/pic_2974cb71db2cdda419c2063bc5696ad6.jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
...
<html>
<head>
<title>Водопад и потерянные вещи</title>
	 ...
	 <div class="wrap">
		  ...
		  <div class="cont span_2_of_3">
			<div class="about-left">
				<h3>Потерянные в Ниагарском парке вещи продадут с аукциона</h3>
			</div>
				<div class="blog-img"><img src="/assets/basetheme-design/images/pic_2974cb71db2cdda419c2063bc5696ad6.jpg" alt=""/></div>
			     <div class="blog">
					<div class="cont span_2_of_blog">
				 <p>Солнечные очки, штативы, прогулочные детские коляски и другие вещи, потерянные в Ниагарском парке, будут проданы с аукциона. Как сообщает The Daily Mail, это произойдет, если за ними не обратятся первоначальные владельцы.</p>
<p>
Чтобы вернуть ювелирные украшения, мобильные телефоны, кошельки, сумки и другие вещи, на официальном сайте парка можно оставить сообщение о том, какая вещь, где и когда была утеряна. Если к концу года владелец вещи не объявится, она станет лотом канадского аукциона Luke\'s Auctions.
</p>
<p>Девиз аукциона — «по крайней мере, вы вернетесь домой с чем-нибудь». Ставки будут начинаться от пяти долларов за предмет, первоначальная стоимость которого составляла 100 долларов.</p>
